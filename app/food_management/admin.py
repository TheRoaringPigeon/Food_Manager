...
from .models import Ingredient, Recipe, RecipeIngredient, IngredientInventory, PreparedFood, MealLog
...
class RecipeAdmin(admin.ModelAdmin):
  list_display = ['name', 'servings', 'prep_time_minutes', 'cook_time_minutes', 'favorite']
...
class MealLogAdmin(admin.ModelAdmin):
  list_display = ['recipe', 'prepared_food', 'meal_date', 'meal_type', 'servings', 'notes', 'created_at']
  list_filter = ['recipe', 'prepared_food', 'meal_type', 'meal_date']
  search_fields = ['recipe', 'prepared_food', 'meal_date']
