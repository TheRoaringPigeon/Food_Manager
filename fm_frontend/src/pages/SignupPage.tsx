  ...
  return (
    <div className="min-h-screen background-canvas flex items-center justify-center">
      <div className="background-surface rounded-lg shadow-sm border border-line p-8 w-full max-w-sm">
        <h1 className="text-xl font-semibold foreground-content mb-2">Create an account</h1>
        <p className="text-sm foreground-subtle mb-6">
          An admin will assign you to a family after you sign up.
        </p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            <label className="block text-sm font-medium foreground-content">Password</label>
            <input
              type="password"
              value={password}
        ...
        <p className="mt-4 text-sm foreground-subtle text-center">
          ...
          <Link to="/login" className="foreground-primary hover:underline">Sign in</Link>
        </p>
      </div>
    </div>
  )
